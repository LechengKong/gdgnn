...
from models.link_predictor import RelLinkPredictor
...
if __name__ == '__main__':
    ...
    gnn = gnn_model(params.num_layers, params.aug_num_rels, params.inp_dim, params.emb_dim, params.num_bases, drop_ratio=params.dropout, JK=params.JK)

    model = dgl_model(params.emb_dim, params.num_rels, gnn, feature_list).to(params.device)
